...
public class TabsParkingAdapter extends FragmentPagerAdapter {
    ...
    public TabsParkingAdapter(FragmentManager fragmentManager) {
...
//    	parkingStepsGuide = new ParkingStepsGuide();
    ...
    public Fragment getItem(int position) {
        ...
        case 1: // Fragment # 2 - This will show FirstFragment different title
            ...
            step_2 = (ImageView) rootView.findViewById(R.id.parking_steps);
        ...
        case 2:
        	  return new ParkingStepsGuide(){
              	...
              	public View onCreateView(LayoutInflater inflater,
              			ViewGroup container, Bundle savedInstanceState) {
              		View rootView = inflater.inflate(R.layout.parking_steps_page, container, false);
              step_3 = (ImageView) rootView.findViewById(R.id.parking_steps);
              step_3.setBackgroundResource(R.drawable.tutorials_parking_step3);
              		return rootView;
              	}
              };
        default:
